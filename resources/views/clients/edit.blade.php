    ...
    <div class="col-md-8 col-md-offset-2">
      ...
      <form action="/clients/{{ $clientInfo->id }}" method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" name="clientIndustry" class="form-control" id="clientIndustry" value="{{ $clientInfo->clientIndustry }}">
        </div>
        <div class="form-group">
          <label for="commission">Commission</label>
          <input type="text" name="commission" class="form-control" id="commission" value="{{ $clientInfo->commission }}">
        </div>
        <div class="form-group">
